...
function init(){
	document.getElementById("hw_1").innerHTML="<a class='hw-link' href='https://helloworld.co.in' target='_blank'>helloworld.co.in</a>";
	document.getElementById("hw_2").innerHTML="<a class='hw-link' href='https://github.com/jiteshsaini' target='_blank'>GitHub</a>";
	document.getElementById("hw_3").innerHTML="<a class='hw-link' href='https://www.youtube.com/channel/UC_2OyRNVCWCH8ipgmAoJ1mA' target='_blank'>YouTube</a>";
	document.getElementById("hw_4").innerHTML="<a class='hw-link' href='https://www.buymeacoffee.com/helloworld10' target='_blank'>BuyMeCoffee</a>";
