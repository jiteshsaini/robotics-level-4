...
printf("<div align='center' id='box_outer'>");//------------------------
	echo"<div align='center' id='box_title'>";
		...
		echo"<div class='box_controls' style='width:22%'>";
			echo"<zz>";
				echo"<label class='floatLabel'>Adv Controls</label><br>";
				echo"<div style='float:left;width:25%;border:0px solid blue'>";
				...
				echo"</div>";
				echo"<div style='float:left;width:25%;margin-left:5%;border:0px solid red'>";
